...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5616176315').split()]

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002334859504').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002412649607')
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://globalsaruar:FaTG1zd2VVpiyprt@cluster0.5mwhc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/AuraBots')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/aurabots')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Aurabotschat') # Support Chat Link Without https:// or @
